...
const VerifyCode = ({email}) => {
  ...
  return (
    <div className='p-4'>
      ...
      <input type='text' name='code' value={values?.code} maxLength={6} onChange={handleOnChange} placeholder='6 digit code' className='h-12 border rounded border-gray-600 p-2 mt-4' required/>
      <button type='submit' className='border w-30 rounded-lg h-12 bg-black text-white mb-4'>Verify</button>
      </form>
